<%@ page title="" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="EMS_ReImbursementMaster, App_Web_1zdtagca" %>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        <label class="">Head Code</label>
                                                                        <asp:TextBox ID="txtHeadCode" runat="server" CssClass="form-control text-uppercase" AutoComplete="off"
                                                                             onfocus="this.select();"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="rfv_txtHeadCode" runat="server"
                                                                            ControlToValidate="txtHeadCode" SetFocusOnError="true" Display="None"
                                                                            ErrorMessage="Head Code can not be blank" ValidationGroup="save" Font-Size="8pt">
                                                                        </asp:RequiredFieldValidator>
                                                                        <AjaxTools:ValidatorCalloutExtender ID="vce_txtHeadCode" runat="server"
                                                                            PopupPosition="BottomRight" Enabled="True" TargetControlID="rfv_txtHeadCode">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:TextBox ID="txtHeadName" runat="server" CssClass="form-control text-uppercase" AutoComplete="off"
                                                                             onfocus="this.select();"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="rfv_txtHeadName" runat="server"
                                                                            ControlToValidate="txtHeadName" SetFocusOnError="true" Display="None"
                                                                            ErrorMessage="Head Name can not be blank" ValidationGroup="save" Font-Size="8pt">
                                                                        </asp:RequiredFieldValidator>
                                                        ...
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="height: auto;">
                                                                <asp:GridView ID="grdMasterView" runat="server" AllowPaging="true"
                                                                    ...
                                                                    Width="100%" CssClass="table table-bordered table-hover" DataKeyNames="HeadID"
