<%@ page title="" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="EMS_PurposeMaster, App_Web_1zdtagca" %>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="">Purpose<span class="text-danger">*</span></label>
                                                                <asp:TextBox ID="txtPurpose" runat="server" TextMode="MultiLine" CssClass="form-control text-uppercase"
                                                                    MaxLength="200" AutoComplete="off" onfocus="this.select();"></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="rfv_txtPurpose" runat="server" ControlToValidate="txtPurpose"
                                                                    SetFocusOnError="true" Display="None" ErrorMessage="Purpose can not be blank"
                                                                    ValidationGroup="save" Font-Size="8pt">
                                                                </asp:RequiredFieldValidator>
                                                                <AjaxTools:ValidatorCalloutExtender ID="vce_txtPurpose" runat="server"
                                                                    PopupPosition="BottomRight" Enabled="True" TargetControlID="rfv_txtPurpose">
                                                        ...
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="height: auto;">
                                                                <asp:GridView ID="grdMasterView" runat="server" AllowPaging="false"
                                                                    ...
                                                                    Width="100%" CssClass="table table-bordered table-hover" DataKeyNames="PurposeID"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="ACTION" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btn btn-warning" Text="<i class='material-icons'>edit</i>" OnClick="lnkUpdate_Click"
                                                                                    CommandArgument='<%#Eval("PurposeID")%>' />
                                                                            </ItemTemplate>
