<%@ page title="Finance Employee" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="EMS_FinanceEmployee, App_Web_1zdtagca" %>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                <div class="col-md-5">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:TextBox ID="txtEmployeeName" runat="server" CssClass="form-control text-uppercase"
                                                                            onfocus="this.select()" AutoPostBack="true" OnTextChanged="txtEmployeeName_TextChanged"></asp:TextBox>
                                                                ...
                                                                <div class="col-md-5">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <AjaxTools:ValidatorCalloutExtender ID="vce_txtEmailID" PopupPosition="BottomRight"
                                                                         ...
                                                                         <asp:RequiredFieldValidator ID="rfv_txtEmailID1" runat="server" ControlToValidate="txtEmailID"
                                                                            SetFocusOnError="true" Display="None" ErrorMessage="Email ID can not be blank !"
                                                                            ValidationGroup="save" Font-Size="8pt"></asp:RequiredFieldValidator>
                                                                        <AjaxTools:ValidatorCalloutExtender ID="vce_txtEmailID1" runat="server" Enabled="True"
                                                                            TargetControlID="rfv_txtEmailID1">
                                                                        </AjaxTools:ValidatorCalloutExtender>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                ...
                                                                <div class="col-md-3 mt-3 pt-2">
                                                                    <div class="form-group" runat="server" visible="true" id="trActive">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 text-center">
                                                                    <input type="button" id="htmlSave" runat="server" class="btn btn-danger" value="Save" onclick="DisableSaveClick();" />
                                                                    <asp:Button ID="btnSave" runat="server" CssClass="d-none" OnClick="btnSave_Click" />
                                                                    <input type="button" id="htmlUpdate" runat="server" class="btn btn-danger" value="Update" onclick="DisableUpdateClick();" />
                                            ...
                                            <div class="card-header card-header-warning  pr-0 pl-0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 pl-0 pr-0 d-flex">
                                                        ...
                                                        <button id="btnAdd" onserverclick="btnAdd_Click" runat="server" class="btn btn-default mt-0 mb-0"><i class="material-icons">add_circle_outline</i></button>
                                                        ...
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="height: auto;width: 80vw;">
                                                                <asp:GridView ID="grdMasterView" runat="server" AllowPaging="true"
                                                                    ...
                                                                    Width="100%" CssClass="table table-bordered table-hover" DataKeyNames="FinanceEmployeeID"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="ACTION" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btn btn-info" Text="<i class='material-icons'>edit</i>" OnClick="lnkUpdate_Click"
                                                                                    CommandArgument='<%#Eval("FinanceEmployeeID")%>' />
                                                                            </ItemTemplate>
