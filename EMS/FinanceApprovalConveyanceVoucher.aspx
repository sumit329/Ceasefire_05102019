<%@ page title="Finance Approval Conveyance Voucher" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="EMS_FinanceApprovalConveyanceVoucher, App_Web_1zdtagca" %>
                                                                                    ...
                                                                                    <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="height: auto; width: auto;">
                                                                                        <asp:GridView ID="grdTransaction" runat="server" AllowPaging="false"
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="Distance Between Office & Home">
                                                                                                    <ItemTemplate>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="Amount Claimed">
                                                                                                    <ItemTemplate>
                                                                                                        <%#Eval("Amount Claimed")%>
                                                                                                    </ItemTemplate>
                                                                                                    <HeaderStyle HorizontalAlign="Center" Wrap="false" />
