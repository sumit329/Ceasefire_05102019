<%@ page title="" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="EMS_TransportModeMaster, App_Web_1zdtagca" %>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <asp:Label ID="lblheader" runat="server" CssClass="h4 card-title"
                                                            Text="Transport Mode Master"></asp:Label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        <label class="">Transport Mode Code<span class="text-danger">*</span></label>
                                                                        <asp:TextBox ID="txtTransportModeCode" runat="server" CssClass="form-control text-uppercase"
                                                                            MaxLength="7" Enabled="false" AutoComplete="off" onfocus="this.select();"></asp:TextBox>
                                                                        <%--<asp:RequiredFieldValidator ID="rfv_txtTransportModeCode" runat="server" ControlToValidate="txtTransportModeCode"
                                                                            SetFocusOnError="true" Display="None" ErrorMessage="Transport Mode Code can not be blank"
                                                                            ValidationGroup="save" Font-Size="8pt">
                                                                        </asp:RequiredFieldValidator>
                                                                        <AjaxTools:ValidatorCalloutExtender ID="vce_txtTransportModeCode" runat="server"
                                                                            PopupPosition="BottomRight" Enabled="True" TargetControlID="rfv_txtTransportModeCode">
                                                                        </AjaxTools:ValidatorCalloutExtender>--%>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="">Transport Mode Name<span class="text-danger">*</span></label>
                                                                        <asp:TextBox ID="txtTransportModeName" runat="server" CssClass="form-control text-uppercase"
                                                                            MaxLength="200" AutoComplete="off" onfocus="this.select();"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="rfv_txtTransportModeName" runat="server" ControlToValidate="txtTransportModeName"
                                                                            SetFocusOnError="true" Display="None" ErrorMessage="Transport Mode Name can not be blank"
                                                                            ValidationGroup="save" Font-Size="8pt">
                                                                        </asp:RequiredFieldValidator>
                                                                        <AjaxTools:ValidatorCalloutExtender ID="vce_txtTransportModeName" runat="server"
                                                                            PopupPosition="BottomRight" Enabled="True" TargetControlID="rfv_txtTransportModeName">
                                                                        </AjaxTools:ValidatorCalloutExtender>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        <label class="">Rate Per Km<%--<span class="text-danger">*</span>--%></label>
                                                                        <asp:TextBox ID="txtRatePerKm" runat="server" CssClass="form-control text-uppercase text-right"
                                                                            MaxLength="7" AutoComplete="off" onfocus="this.select();"></asp:TextBox>
                                                                        <%--<asp:RequiredFieldValidator ID="rfv_txtRatePerKm" runat="server" ControlToValidate="txtRatePerKm"
                                                                            SetFocusOnError="true" Display="None" ErrorMessage="Rate Per Km can not be blank"
                                                                            ValidationGroup="save" Font-Size="8pt">
                                                                        </asp:RequiredFieldValidator>
                                                                        <AjaxTools:ValidatorCalloutExtender ID="vce_txtRatePerKm" runat="server"
                                                                            PopupPosition="BottomRight" Enabled="True" TargetControlID="rfv_txtRatePerKm">
                                                                        </AjaxTools:ValidatorCalloutExtender>--%>
                                                                        <AjaxTools:FilteredTextBoxExtender ID="fte_txtRatePerKm" runat="server" FilterType="Numbers,Custom"
                                                                            TargetControlID="txtRatePerKm">
                                                                        </AjaxTools:FilteredTextBoxExtender>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        <label class="">With Effective From<span class="text-danger">*</span></label>
                                                                        <asp:TextBox ID="txtWithEffectiveFrom" runat="server" AutoComplete="off"
                                                                            onfocus="this.select();" CssClass="form-control text-uppercase"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="rfv1_txtWithEffectiveFrom" runat="server" ControlToValidate="txtWithEffectiveFrom"
                                                                            Display="None" ErrorMessage="With Effective From can not be blank !" ValidationGroup="report"
                                                                            Font-Size="8pt">
                                                                        </asp:RequiredFieldValidator>
                                                                        <AjaxTools:ValidatorCalloutExtender ID="vce1_txtWithEffectiveFrom" runat="server" Enabled="True"
                                                                            PopupPosition="TopRight" TargetControlID="rfv1_txtWithEffectiveFrom">
                                                                        </AjaxTools:ValidatorCalloutExtender>
                                                                        <AjaxTools:CalendarExtender ID="vce_txtWithEffectiveFrom" runat="server" Format="dd/MM/yyyy" TargetControlID="txtWithEffectiveFrom">
                                                                        </AjaxTools:CalendarExtender>
                                                                        <AjaxTools:MaskedEditExtender ID="Msk_txtWithEffectiveFrom" runat="server" ClearTextOnInvalid="True"
                                                                            CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat=""
                                                                            CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder=""
                                                                            CultureTimePlaceholder="" Enabled="True" Mask="99/99/9999" MaskType="Date" TargetControlID="txtWithEffectiveFrom"
                                                                            UserDateFormat="DayMonthYear">
                                                                        </AjaxTools:MaskedEditExtender>
                                                                        <asp:RegularExpressionValidator ID="rev_txtWithEffectiveFrom" runat="server" ControlToValidate="txtWithEffectiveFrom"
                                                                        ...
                                                                        <AjaxTools:ValidatorCalloutExtender ID="vce2_txtWithEffectiveFrom" runat="server" Enabled="True"
                                                                            TargetControlID="rev_txtWithEffectiveFrom">
                                                                        </AjaxTools:ValidatorCalloutExtender>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2 mt-4">
                                                                    <div class="form-group" runat="server">
                                                                        <label class="">Bill Required</label>
                                                                        <asp:CheckBox ID="chkIsBillRequired" runat="server" Checked="true" CssClass="checkbox" />
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2 mt-4">
                                                        ...
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="height: auto;">
                                                                <asp:GridView ID="grdMasterView" runat="server" AllowPaging="false"
                                                                    ...
                                                                    Width="100%" CssClass="table table-bordered table-hover" DataKeyNames="TransportModeID"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="ACTION" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btn btn-warning" Text="<i class='material-icons'>edit</i>" OnClick="lnkUpdate_Click"
                                                                                    CommandArgument='<%#Eval("TransportModeID")%>' />
                                                                            </ItemTemplate>
