<%@ page title="Role Wise Tag Permission" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="FMS_RoleWiseTagPermission, App_Web_4xfo1so1" %>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card" id="cardInput" runat="server">
                                            <div class="card-header card-header-info">
                                                <asp:Label ID="lblheader" runat="server" Text="Role Wise Tag Permission" CssClass="h4 card-title"></asp:Label>
                                            </div>
                                            <div class="card-body">
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                <div class="col-md-12 mt-3">
                                                                    <div class="form-group">
                                                                        <asp:CheckBox ID="chkPendingPI" runat="server" CssClass="pr-3" Text="Pending PI"></asp:CheckBox>
                                                                        <asp:CheckBox ID="chkPendingPO" runat="server" CssClass="pr-3" Text="Pending PO"></asp:CheckBox>
                                                                        <asp:CheckBox ID="chkItemMinimumLevel" runat="server" CssClass="pr-3" Text="Item Minimum Level"></asp:CheckBox>
                                                                        <asp:CheckBox ID="chkVOC" runat="server" CssClass="pr-3" Text="Feedback/Suggestion" Checked="true"></asp:CheckBox>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 mt-3">
                                                                    <div class="form-group">
                                                                        <asp:CheckBox ID="chkFMSAudit" runat="server" CssClass="pr-3" Text="FMS Audit"></asp:CheckBox>
                                                                        <asp:CheckBox ID="chkSupervisorAudit" runat="server" CssClass="pr-3" Text="Supervisor Audit"></asp:CheckBox>
                                                                        <asp:CheckBox ID="chkVirtualAudit" runat="server" CssClass="pr-3" Text="Virtual Audit"></asp:CheckBox>
                                                                        <asp:CheckBox ID="chkSupervisorAuditChart" runat="server" CssClass="pr-3" Text="Supervisor Audit Chart"></asp:CheckBox>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 mt-3">
                                                                    <div class="form-group">
                                                                        <asp:CheckBox ID="chkJobSkillAuditChart" runat="server" CssClass="pr-3" Text="Job Skill Audit Chart"></asp:CheckBox>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="height: auto; width: 80vw;">
                                                                <asp:GridView ID="grdMasterView" runat="server" AllowPaging="true"
                                                                    ...
                                                                    Width="100%" CssClass="table table-bordered table-hover" DataKeyNames="RoleWiseTagPermissionID"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="ACTION" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btn btn-info" Text="<i class='material-icons'>edit</i>" OnClick="lnkUpdate_Click"
                                                                                    CommandArgument='<%#Eval("RoleWiseTagPermissionID")%>' />
                                                                            </ItemTemplate>
