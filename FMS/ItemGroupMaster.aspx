<%@ page title="" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="FMS_ItemGroupMaster, App_Web_4xfo1so1" %>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card" id="cardInput" runat="server">
                                            <div class="card-header card-header-info">
                                                ...
                                                <%--<h4 class="card-title">Item Group Master</h4>--%>
                                            </div>
                                            <div class="card-body">
                                                <div class="container-fluid">
                                                    <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-7">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:TextBox ID="txtItemGroup" runat="server" CssClass="form-control text-uppercase" AutoComplete="off"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-5 text-left mt-3 pt-2">
                                            ...
                                            <div class="card-header card-header-info  pr-0 pl-0">
                                                <div class="row">
                                                    <div class="col-md-3 pr-0 pl-0 mt-2 text-right">
                                                        <label class="text-white">Search by Item Group</label>
                                                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="height: auto;width:80vw">
                                                                <asp:GridView ID="grdMasterView" runat="server" AllowPaging="true"
                                                                    ...
                                                                    Width="100%" CssClass="table table-bordered table-hover" DataKeyNames="ItemGroupID"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="ACTION" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btn btn-info" Text="<i class='material-icons'>edit</i>" OnClick="lnkUpdate_Click"
                                                                                    CommandArgument='<%#Eval("ItemGroupID")%>' />
                                                                            </ItemTemplate>
