<%@ page title="FMS Audit" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="FMS_FMSAudit, App_Web_4xfo1so1" %>
                                                                        ...
                                                                        <asp:GridView ID="grdTransaction" runat="server" AllowPaging="false"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Audit Description">
                                                                                    ...
                                                                                    <HeaderStyle HorizontalAlign="Left" Wrap="true" Width="450px" />
                                                                                    <ItemStyle HorizontalAlign="Left" Width="450px" Wrap="true" />
                                                                                </asp:TemplateField>
                                                    ...
                                                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" Style="height: auto;">
                                                        <asp:GridView ID="grdMasterView" runat="server" AllowPaging="true"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="ACTION" ItemStyle-HorizontalAlign="Center">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btn btn-info" Text="<i class='material-icons'>edit</i>" OnClick="lnkUpdate_Click"
                                                                            CommandArgument='<%#Eval("AuditPlannerID")%>' />
                                                                    </ItemTemplate>
                                                                ...
                                                                <asp:TemplateField HeaderText="Visit Start Date">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblVisitStartDate" runat="server" Text='<%#Eval("Visit Start Date")%>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" Wrap="false" />
                                                                    <ItemStyle HorizontalAlign="Left" CssClass="txtuppper" Wrap="false" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Visit End Date">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblVisitEndDate" runat="server" Text='<%#Eval("Visit End Date")%>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <HeaderStyle HorizontalAlign="Left" Wrap="false" />
                                                                    <ItemStyle HorizontalAlign="Left" CssClass="txtuppper" Wrap="false" />
                                                                </asp:TemplateField>
