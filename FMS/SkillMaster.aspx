<%@ page title="Skill Master" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="FMS_SkillMaster, App_Web_4xfo1so1" %>
                                            ...
                                            <div class="card-header card-header-info">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <%--<h4 class="card-title">Skill Master</h4>--%>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="">Skill Type<span class="text-danger">*</span></label>
                                                                        <asp:DropDownList ID="ddlSkillType" runat="server" CssClass="form-control text-uppercase" AutoPostBack="True">
                                                                            <asp:ListItem Enabled="true" Value="WORK" Text="WORK"></asp:ListItem>
                                                                            <asp:ListItem Enabled="true" Value="BEHAVIOUR" Text="BEHAVIOUR"></asp:ListItem>
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <AjaxTools:AutoCompleteExtender OnClientPopulated="onListPopulated"
                                                                            ...
                                                                            MinimumPrefixLength="1" ServiceMethod="GetCategory_SkillHelp" ServicePath="~/WService.asmx"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="">Skill Description<span class="text-danger">*</span></label>
                                                                        <asp:TextBox ID="txtSkillDescription" runat="server" CssClass="form-control text-uppercase"
                                                                            MaxLength="500" AutoComplete="off" onfocus="this.select();"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="">Impact<span class="text-danger">*</span></label>
                                                                        <asp:DropDownList ID="ddlImpact" runat="server" CssClass="form-control col-md-4 text-uppercase">
                                                                            <asp:ListItem Value="LOW" Text="LOW" Selected="True"></asp:ListItem>
                                            ...
                                            <div class="card-header card-header-info">
                                                <div class="row">
                                                    <div class="col-md-3 pr-0 pl-0 mt-2 text-right">
                                                        <label class="text-white">Search by Skill Type</label>
                                                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="height: auto;width:80vw;">
                                                                <asp:GridView ID="grdMasterView" runat="server" AllowPaging="true"
                                                                    ...
                                                                    Width="100%" CssClass="table table-bordered table-hover" DataKeyNames="SkillMasterID"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="ACTION" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btn btn-info" Text="<i class='material-icons'>edit</i>" OnClick="lnkUpdate_Click"
                                                                                    CommandArgument='<%#Eval("SkillMasterID")%>' />
                                                                            </ItemTemplate>
