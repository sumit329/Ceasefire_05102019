<%@ page title="Area Master" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="FMS_AreaMaster, App_Web_4xfo1so1" %>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="">Area Code<span class="text-danger">*</span></label>
                                                                        <asp:TextBox ID="txtAreaCode" runat="server" CssClass="form-control col-md-6 text-uppercase"
                                                                            AutoComplete="off" onfocus="this.select();"></asp:TextBox>
                                                                        <asp:RequiredFieldValidator ID="rfv_txtAreaCode" runat="server"
                                                                            ControlToValidate="txtAreaCode" SetFocusOnError="true" Display="None"
                                                                            ErrorMessage="Area Code can not be blank" ValidationGroup="save" Font-Size="8pt">
                                                                        </asp:RequiredFieldValidator>
                                                                        <AjaxTools:ValidatorCalloutExtender ID="vce_txtAreaCode" runat="server"
                                                                            PopupPosition="BottomRight" Enabled="True" TargetControlID="rfv_txtAreaCode">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="rfv_txtAreaName" runat="server" ControlToValidate="txtAreaName"
                                                                            SetFocusOnError="true" CssClass="d-none" ErrorMessage="Area Name can not be blank"
                                                                            ValidationGroup="save" Font-Size="8pt">
                                                                        </asp:RequiredFieldValidator>
                                                                        <AjaxTools:ValidatorCalloutExtender ID="vce_txtAreaName" runat="server"
                                                                            PopupPosition="BottomRight" Enabled="True" TargetControlID="rfv_txtAreaName">
                                                                        </AjaxTools:ValidatorCalloutExtender>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="card-header card-header-info">
                                                <div class="row">
                                                    <div class="col-md-3 pr-0 pl-0 mt-2 text-right">
                                                        <label class="text-white">Search by Area Code or Name</label>
                                                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="height: auto;width: 80vw;">
                                                                <asp:GridView ID="grdMasterView" runat="server" AllowPaging="true"
                                                                    ...
                                                                    Width="100%" CssClass="table table-bordered table-hover" DataKeyNames="AreaID"
