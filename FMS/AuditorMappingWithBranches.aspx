<%@ page title="Auditor Mapping With Branches" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="FMS_AuditorMappingWithBranches, App_Web_4xfo1so1" %>
        ...
        function pageLoad(sender, e) {
            ...
            if (o != null) {
                o.add_populating(function () {
                    o.set_contextKey($get("<%=txtOfficeName.ClientID %>").value + "|" + $get("<%=ddlEmployee.ClientID%>").value);
                  }
              );
              }
          }
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-2 pr-0">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:DropDownList ID="ddlEmployee" runat="server" CssClass="form-control text-uppercase"
                                                                ...
                                                                <div class="col-md-5 pl-0">
                                                                    <div class="form-group">
                                                                        <label>&nbsp;</label>
                                                                        <asp:TextBox ID="txtEmployeeName" runat="server" CssClass="form-control text-uppercase" AutoComplete="off" onfocus="this.select();"></asp:TextBox>
                                                                        <AjaxTools:AutoCompleteExtender OnClientPopulated="onListPopulated"
                                                                            ...
                                                                            CompletionListItemCssClass="autocomplete_listItem"
                                                                            DelimiterCharacters="" EnableCaching="False" Enabled="True" FirstRowSelected="True"
                                                                            MinimumPrefixLength="1" ServiceMethod="GetEmployeeSelfOrAllHelp" ServicePath="~/WService.asmx"
                                            ...
                                            <div class="card-header card-header-info">
                                                <div class="row">
                                                    <div class="col-md-4 pr-0 pl-0 mt-2 text-right">
                                                        <label class="text-white">Search by Office or Employee Name</label>
                                                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="height: auto;width: 80vw;">
                                                                <asp:GridView ID="grdMasterView" runat="server" AllowPaging="true"
                                                                    ...
                                                                    Width="100%" CssClass="table table-bordered table-hover" DataKeyNames="MappingID"
