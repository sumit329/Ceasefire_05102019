<%@ page title="Virtual Audit" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="FMS_VirtualAudit, App_Web_4xfo1so1" %>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="width: 80vw;">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card" id="cardInput" runat="server" visible="false">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:Label ID="lblBranchName" runat="server" CssClass="form-control text-uppercase"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:Label ID="lblAreaName" runat="server" CssClass="form-control text-uppercase"
                                                                    AutoComplete="off" onfocus="this.select();"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="">Audit Completion Date Time</label>
                                                                <asp:Label ID="lblAuditCompletionDateTime" runat="server" CssClass="form-control text-uppercase"
                                                                    AutoComplete="off" onfocus="this.select();"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:Label ID="lblImageRequired" runat="server" CssClass="form-control text-uppercase"
                                                                    AutoComplete="off" onfocus="this.select();"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:Label ID="lblVideoRequired" runat="server" CssClass="form-control text-uppercase"
                                                                    AutoComplete="off" onfocus="this.select();"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="">Requested Date Time</label>
                                                                <asp:Label ID="lblRequestedDateTime" runat="server" CssClass="form-control text-uppercase"
                                                                    AutoComplete="off" onfocus="this.select();"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:Label ID="lblRemarks" runat="server" CssClass="form-control text-uppercase"
                                                                    AutoComplete="off" onfocus="this.select();"></asp:Label>
                                                            </div>
                                                        </div>

                                                        <div class="col-md-6">
                                                            <label class="">Upload Image<span id="spanImage" runat="server" class="text-danger">*</span></label>
                                                            <asp:FileUpload ID="fuImage" runat="server" CssClass="custom-file" />
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="">Upload Video<span id="spanVideo" runat="server" class="text-danger">*</span></label>
                                                            <asp:FileUpload ID="fuVideo" runat="server" CssClass="custom-file" />
                                                        </div>
                                            ...
                                            <div class="card-header card-header-info  pr-0 pl-0">
                                                <div class="row">
                                                    <div class="col-md-3 pr-0 pl-0 mt-2 text-right">
                                                        <label class="text-white">Search by Area Name</label>
                                                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="height: auto;width:80vw;">
                                                                <asp:GridView ID="grdMasterView" runat="server" AllowPaging="true"
                                                                    ...
                                                                    Width="100%" CssClass="table table-bordered table-hover" DataKeyNames="VirtualAuditRequestID"
