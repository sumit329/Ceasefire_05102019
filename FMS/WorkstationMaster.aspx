<%@ page title="Workstation Master" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="FMS_WorkstationMaster, App_Web_4xfo1so1" %>
                                            ...
                                            <div class="card-header card-header-info">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <%--<h4 class="card-title">Workstation Master</h4>--%>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        <label class="">Asset<span class="text-danger">*</span></label>
                                                                        <asp:DropDownList ID="ddlAsset" runat="server" CssClass="form-control text-uppercase"
                                                                            AutoComplete="off" onfocus="this.select();">
                                                                            <asp:ListItem Text="LAND LORD" Value="LAND LORD"></asp:ListItem>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:TextBox ID="txtAreaName" runat="server" CssClass="form-control text-uppercase"
                                                                            AutoComplete="off" onfocus="this.select();"></asp:TextBox>
                                                                        <AjaxTools:AutoCompleteExtender OnClientPopulated="onListPopulated"
                                                                            runat="server" ID="ace_AreaName" BehaviorID="ace_AreaName" CompletionInterval="10"
                                                                            CompletionListCssClass="autocomplete_completionListElement"
                                                                            CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                                                                            CompletionListItemCssClass="autocomplete_listItem"
                                                                            DelimiterCharacters="" EnableCaching="False" Enabled="True" FirstRowSelected="True"
                                                                            MinimumPrefixLength="1" ServiceMethod="GetAreaHelp" ServicePath="~/WService.asmx"
                                                                            TargetControlID="txtAreaName" UseContextKey="false">
                                                                        </AjaxTools:AutoCompleteExtender>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="">Sub Area Name<span class="text-danger">*</span></label>
                                                                        <asp:TextBox ID="txtSubAreaName" runat="server" CssClass="form-control text-uppercase"
                                                                            AutoComplete="off" onfocus="this.select();"></asp:TextBox>
                                                                        <AjaxTools:AutoCompleteExtender OnClientPopulated="onListPopulated"
                                                                            runat="server" ID="ace_SubAreaName" BehaviorID="ace_SubAreaName" CompletionInterval="10"
                                                                            CompletionListCssClass="autocomplete_completionListElement"
                                                                            CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                                                                            CompletionListItemCssClass="autocomplete_listItem"
                                                                            DelimiterCharacters="" EnableCaching="False" Enabled="True" FirstRowSelected="True"
                                                                            MinimumPrefixLength="1" ServiceMethod="GetAreaHelp" ServicePath="~/WService.asmx"
                                                                            TargetControlID="txtSubAreaName" UseContextKey="false">
                                                                        </AjaxTools:AutoCompleteExtender>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="">WS Code<span class="text-danger">*</span></label>
                                                                        <asp:TextBox ID="txtWSCode" runat="server" CssClass="form-control text-uppercase"
                                                        ...
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="width: 80vw;">
                                                                <asp:GridView ID="grdMasterView" runat="server" AllowPaging="false"
                                                                    ...
                                                                    Width="100%" CssClass="table table-bordered table-hover" DataKeyNames="WorkstationID"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="ACTION" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btn btn-info" Text="<i class='material-icons'>edit</i>" OnClick="lnkUpdate_Click"
                                                                                    CommandArgument='<%#Eval("WorkstationID")%>' />
                                                                            </ItemTemplate>
