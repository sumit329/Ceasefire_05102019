<%@ page title="Category Master" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="FMS_CategoryMaster, App_Web_4xfo1so1" %>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:DropDownList ID="ddlCategoryType" runat="server" CssClass="form-control text-uppercase">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:TextBox ID="txtCategory" runat="server" CssClass="form-control text-uppercase" AutoComplete="off"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="card-header card-header-info">
                                                <div class="row">
                                                    <div class="col-md-3 pr-0 pl-0 mt-2 text-right">
                                                        <label class="text-white">Search by Category</label>
                                                    </div>
