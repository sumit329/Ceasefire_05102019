<%@ page title="Complaint Handelers" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="FMS_ComplaintHandelers, App_Web_4xfo1so1" %>
                                            ...
                                            <div class="card-header card-header-info">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <%--<h4 class="card-title">Complaint Handelers</h4>--%>
                                                    </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <asp:Panel ID="divDetail" runat="server" ScrollBars="Auto" Style="height: auto;width: 80vw;">
                                                                <asp:GridView ID="grdMasterView" runat="server" AllowPaging="true"
                                                                    ...
                                                                    Width="100%" CssClass="table table-bordered table-hover" DataKeyNames="ComplaintHandlerID"
                                                                        ...
                                                                        <asp:TemplateField HeaderText="ACTION" ItemStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lnkUpdate" runat="server" CssClass="btn btn-info" Text="<i class='material-icons'>edit</i>" OnClick="lnkUpdate_Click"
                                                                                    CommandArgument='<%#Eval("ComplaintHandlerID")%>' />
                                                                            </ItemTemplate>
