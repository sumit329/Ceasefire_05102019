<%@ page title="" language="C#" masterpagefile="~/Default.master" autoeventwireup="true" inherits="Transaction_PurchaseIndent, App_Web_tipgwkmm" %>
        ...
        <div class="container-fluid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtHORemarks" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtBillNo" runat="server" CssClass="form-control disabled" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Bill Date</label>
                                            <asp:TextBox ID="txtBillDate" runat="server" CssClass="form-control disabled" Enabled="false"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="label-on-left">Bill Scan Copy Upload</label>
                                        <asp:FileUpload ID="fuBill" runat="server" CssClass="btn btn-info" />
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <button id="btnSave" runat="server" class="btn btn-info">Save</button>
